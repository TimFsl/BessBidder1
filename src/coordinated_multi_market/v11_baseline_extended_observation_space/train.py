"""
Train PPO Agent — ``v11_baseline_extended_observation_space``:
like v10 (7 DA actions, joint reward, precomputed RI lookup) but observation space
includes the seven EXAA day-ahead forecast statistics (``exaa_pf_daily_*``) as in v3.
"""
...
from src.coordinated_multi_market.v11_baseline_extended_observation_space.basic_battery_dam_env import (
    BasicBatteryDAM,
)
from src.coordinated_multi_market.v11_baseline_extended_observation_space.custom_ppo import (
    CustomPPO,
)
from src.coordinated_multi_market.v11_baseline_extended_observation_space.learning_utils import (
    load_input_data,
    prepare_input_data,
    linear_schedule,
)
...
if __name__ == "__main__":
    ...
    if RESUME_TRAINING:
        ...
        print("Starting training from scratch (v11 precomputed RI lookup, extended obs).")
        model = CustomPPO("MlpPolicy", env, **model_kwargs)
