    ...
    while current_day < end_day:
        ...
        for combo in combos:
            ...
            if not da_trades.empty:
                ...
                buy_mwh = float(da_net["net_buy"].sum()) / 4.0
                sell_mwh = float(da_net["net_sell"].sum()) / 4.0
                r_long_remaining_mwh = max(0.0, buy_mwh * efficiency - sell_mwh/efficiency)
            ...
            while execution_time_end < trading_end:
                ...
                cap = 1.0  # to be replaced with actual battery capacity
                free_mwh = max(0.0, cap - r_long_before)
...
if __name__ == "__main__":
    run_ri_with_synthetic_da_trades(
        ...
        output_path="coordinated_market_upper_bound_analysis/results_open_positions_V1/",
        start_day=pd.Timestamp("2021-04-12", tz="Europe/Berlin"),
