...
from coordinated_market_upper_bound_analysis.testing_rolling_intrinsic_qh_intelligent_stacking_open_positions_V0 import (
...
if __name__ == "__main__":
    run_ri_with_synthetic_da_trades(
        ...
        output_path="coordinated_market_upper_bound_analysis/results_open_positions_V0/",
